...
from ._nmf_online_base_DL import NMFOnlineBase_DL


class NMFOnlineHALS_DL(NMFOnlineBase_DL):
    def __init__(
        self,
        n_components: int,
        init: str,
    ...
    def _update_one_pass(self, l1_reg_W, l2_reg_W):
        ...
        for x, idx in self.dataloader:
            ...
            #print(f"Update H iterates {j+1} iterations.")
            self.H[idx, :] = h
            ...
            #print(f"update W iterates {j+1} iterations.")
    ...
    def _update_H(self):
        ...
        for x, idx in self.dataloader:
            ...
            # print(f"Block update H iterates {j+1} iterations.")
    ...
    def fit(self, X):
        ...
        print('Use Dataloader Online HALS')
